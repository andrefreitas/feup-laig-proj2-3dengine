...
void LSFprimitive::draw(){
	switch(type){
		...
		case vehicle:{
			...
			//boosters
			GLfloat leftBoosterR[16][3] = {
					{15.5, -0.1, 1.7}, {16.0, -0.1, 1.7},  {20.0, 0.0, 1.7},  {20.7, 0.0, 1.7},
					{15.7, -0.4, 1.7}, {16.0, -0.4, 1.7}, {20.0, -0.3, 1.7}, {20.4, -0.3, 1.7},
					{15.9, -0.7, 1.7}, {16.0, -0.7, 1.7}, {20.0, -0.6, 1.7}, {20.4, -0.6, 1.7},
					{16.0, -0.8, 1.8}, {16.0, -0.8, 1.8}, {20.0, -0.7, 1.8}, {20.7, -0.7, 1.8}};
			createEvaluator(&leftBoosterR[0][0], NULL, &texturespoints[0][0]);
			GLfloat leftBoosterRI[16][3] = {
					{16.0, -0.8, 1.8}, {16.0, -0.8, 1.8}, {20.0, -0.7, 1.8}, {20.7, -0.7, 1.8},
					{15.9, -0.7, 1.7}, {16.0, -0.7, 1.7}, {20.0, -0.6, 1.7}, {20.4, -0.6, 1.7},
					{15.7, -0.4, 1.7}, {16.0, -0.4, 1.7}, {20.0, -0.3, 1.7}, {20.4, -0.3, 1.7},
					{15.5, -0.1, 1.7}, {16.0, -0.1, 1.7},  {20.0, 0.0, 1.7},  {20.7, 0.0, 1.7}};
			createEvaluator(&leftBoosterRI[0][0], NULL, &texturespoints[0][0]);

			GLfloat leftBoosterB[16][3] = {
					{16.0, -0.8, 1.8}, {16.0, -0.8, 1.8}, {20.0, -0.7, 1.8}, {20.7, -0.7, 1.8},
					{16.0, -0.9, 1.9}, {16.0, -0.9, 1.9}, {20.0, -0.9, 2.0}, {20.4, -0.9, 1.9},
					{16.0, -0.9, 3.0}, {16.0, -0.9, 3.0}, {20.0, -0.9, 3.0}, {20.4, -0.9, 3.0},
					{16.0, -1.0, 3.0}, {16.0, -1.0, 3.0}, {20.0, -0.9, 3.0}, {20.7, -0.8, 3.1}};
			createEvaluator(&leftBoosterB[0][0], NULL, &texturespoints[0][0]);
			GLfloat leftBoosterBI[16][3] = {
					{16.0, -1.0, 3.0}, {16.0, -1.0, 3.0}, {20.0, -0.9, 3.0}, {20.7, -0.8, 3.1},
					{16.0, -0.9, 3.0}, {16.0, -0.9, 3.0}, {20.0, -0.9, 3.0}, {20.4, -0.9, 3.0},
					{16.0, -0.9, 1.9}, {16.0, -0.9, 1.9}, {20.0, -0.9, 2.0}, {20.4, -0.9, 1.9},
					{16.0, -0.8, 1.8}, {16.0, -0.8, 1.8}, {20.0, -0.7, 1.8}, {20.7, -0.7, 1.8}};
			createEvaluator(&leftBoosterBI[0][0], NULL, &texturespoints[0][0]);

			GLfloat leftBoosterL[16][3] = {
					{16.0, -1.0, 3.0}, {16.0, -1.0, 3.0}, {20.0, -0.9, 3.0}, {20.7, -0.8, 3.1},
					{15.9, -0.9, 3.1}, {16.0, -0.9, 3.1}, {20.0, -0.8, 3.1}, {20.4, -0.5, 3.1},
					{15.7, -0.7, 3.1}, {16.0, -0.7, 3.1}, {20.0, -0.5, 3.1}, {20.4, -0.4, 3.1},
					{15.5, -0.4, 3.1}, {16.0, -0.4, 3.1},  {20.0, -0.2, 3.1},  {20.7, -0.1, 3.1}};
			createEvaluator(&leftBoosterL[0][0], NULL, &texturespoints[0][0]);
			GLfloat leftBoosterLI[16][3] = {
					{15.5, -0.4, 3.1}, {16.0, -0.4, 3.1},  {20.0, -0.2, 3.1},  {20.7, -0.1, 3.1},
					{15.7, -0.7, 3.1}, {16.0, -0.7, 3.1}, {20.0, -0.5, 3.1}, {20.4, -0.4, 3.1},
					{15.9, -0.9, 3.1}, {16.0, -0.9, 3.1}, {20.0, -0.8, 3.1}, {20.4, -0.5, 3.1},
					{16.0, -1.0, 3.0}, {16.0, -1.0, 3.0}, {20.0, -0.9, 3.0}, {20.7, -0.8, 3.1}};
			createEvaluator(&leftBoosterLI[0][0], NULL, &texturespoints[0][0]);

			GLfloat leftBoosterFront[16][3] = {
			...
			createEvaluator(&leftBoosterFront[0][0], NULL, &texturespoints[0][0]);

			GLfloat leftBoosterBack[16][3] = {
			...
			createEvaluator(&leftBoosterBack[0][0], NULL, &texturespoints[0][0]);



			GLfloat rightBoosterR[16][3] = {
					{15.5, -0.1, -1.7}, {16.0, -0.1, -1.7},  {20.0, 0.0, -1.7},  {20.7, 0.0, -1.7},
					{15.7, -0.4, -1.7}, {16.0, -0.4, -1.7}, {20.0, -0.3, -1.7}, {20.4, -0.3, -1.7},
					{15.9, -0.7, -1.7}, {16.0, -0.7, -1.7}, {20.0, -0.6, -1.7}, {20.4, -0.6, -1.7},
					{16.0, -0.8, -1.8}, {16.0, -0.8, -1.8}, {20.0, -0.7, -1.8}, {20.7, -0.7, -1.8}};
			createEvaluator(&rightBoosterR[0][0], NULL, &texturespoints[0][0]);
			GLfloat rightBoosterRI[16][3] = {
					{16.0, -0.8, -1.8}, {16.0, -0.8, -1.8}, {20.0, -0.7, -1.8}, {20.7, -0.7, -1.8},
					{15.9, -0.7, -1.7}, {16.0, -0.7, -1.7}, {20.0, -0.6, -1.7}, {20.4, -0.6, -1.7},
					{15.7, -0.4, -1.7}, {16.0, -0.4, -1.7}, {20.0, -0.3, -1.7}, {20.4, -0.3, -1.7},
					{15.5, -0.1, -1.7}, {16.0, -0.1, -1.7},  {20.0, 0.0, -1.7},  {20.7, 0.0, -1.7}};
			createEvaluator(&rightBoosterRI[0][0], NULL, &texturespoints[0][0]);

			GLfloat rightBoosterB[16][3] = {
					{16.0, -1.0, -3.0}, {16.0, -1.0, -3.0}, {20.0, -0.9, -3.0}, {20.7, -0.8, -3.1},
					{16.0, -0.9, -3.0}, {16.0, -0.9, -3.0}, {20.0, -0.9, -3.0}, {20.4, -0.9, -3.0},
					{16.0, -0.9, -1.9}, {16.0, -0.9, -1.9}, {20.0, -0.9, -2.0}, {20.4, -0.9, -1.9},
					{16.0, -0.8, -1.8}, {16.0, -0.8, -1.8}, {20.0, -0.7, -1.8}, {20.7, -0.7, -1.8}};
			createEvaluator(&rightBoosterB[0][0], NULL, &texturespoints[0][0]);
			GLfloat rightBoosterBI[16][3] = {
					{16.0, -0.8, -1.8}, {16.0, -0.8, -1.8}, {20.0, -0.7, -1.8}, {20.7, -0.7, -1.8},
					{16.0, -0.9, -1.9}, {16.0, -0.9, -1.9}, {20.0, -0.9, -2.0}, {20.4, -0.9, -1.9},
					{16.0, -0.9, -3.0}, {16.0, -0.9, -3.0}, {20.0, -0.9, -3.0}, {20.4, -0.9, -3.0},
					{16.0, -1.0, -3.0}, {16.0, -1.0, -3.0}, {20.0, -0.9, -3.0}, {20.7, -0.8, -3.1}};
			createEvaluator(&rightBoosterBI[0][0], NULL, &texturespoints[0][0]);

			GLfloat rightBoosterL[16][3] = {
					{16.0, -1.0, -3.0}, {16.0, -1.0, -3.0}, {20.0, -0.9, -3.0}, {20.7, -0.8, -3.1},
					{15.9, -0.9, -3.1}, {16.0, -0.9, -3.1}, {20.0, -0.8, -3.1}, {20.4, -0.5, -3.1},
					{15.7, -0.7, -3.1}, {16.0, -0.7, -3.1}, {20.0, -0.5, -3.1}, {20.4, -0.4, -3.1},
					{15.5, -0.4, -3.1}, {16.0, -0.4, -3.1},  {20.0, -0.2, -3.1},  {20.7, -0.1, -3.1}};
			createEvaluator(&rightBoosterL[0][0], NULL, &texturespoints[0][0]);
			GLfloat rightBoosterLI[16][3] = {
					{15.5, -0.4, -3.1}, {16.0, -0.4, -3.1},  {20.0, -0.2, -3.1},  {20.7, -0.1, -3.1},
					{15.7, -0.7, -3.1}, {16.0, -0.7, -3.1}, {20.0, -0.5, -3.1}, {20.4, -0.4, -3.1},
					{15.9, -0.9, -3.1}, {16.0, -0.9, -3.1}, {20.0, -0.8, -3.1}, {20.4, -0.5, -3.1},
					{16.0, -1.0, -3.0}, {16.0, -1.0, -3.0}, {20.0, -0.9, -3.0}, {20.7, -0.8, -3.1}};
			createEvaluator(&rightBoosterLI[0][0], NULL, &texturespoints[0][0]);

			GLfloat rightBoosterFront[16][3] = {
					{16.0, -0.1, -1.7}, {16.0, -0.2, -1.9},  {16.0, -0.3, -2.8},  {16.0, -0.4, -3.1},
					{16.0, -0.4, -1.7}, {16.0, -0.3, -1.9}, {16.0, -0.4, -2.8}, {16.0, -0.7, -3.1},
					{16.0, -0.7, -1.7}, {16.0, -0.8, -1.9}, {16.0, -0.8, -2.8}, {16.0, -0.9, -3.1},
					{16.0, -0.8, -1.8}, {16.0, -0.9, -1.9}, {16.0, -0.9, -2.8}, {16.0, -1.0, -3.0}};
			createEvaluator(&rightBoosterFront[0][0], NULL, &texturespoints[0][0]);

			GLfloat rightBoosterBack[16][3] = {
					{20.4, -0.15, -3.1}, {20.4, -0.1, -3.0},  {20.4, 0.0, -2.0},  {20.4, 0.0, -1.7},
					{20.0, -0.4, -3.1}, {20.0, -0.4, -3.0}, {20.0, -0.4, -2.0}, {20.0, -0.4, -1.7},
					{20.0, -0.5, -3.1}, {20.0, -0.5, -3.0}, {20.0, -0.5, -2.0}, {20.0, -0.6, -1.7},
					{20.3, -0.8, -3.1}, {20.3, -0.9, -3.0}, {20.3, -0.9, -2.0}, {20.3, -0.7, -1.8}};
			createEvaluator(&rightBoosterBack[0][0], NULL, &texturespoints[0][0]);
		}break;
	}
}
